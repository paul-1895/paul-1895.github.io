...
window.BANK_ROWS = [
  ...
  { key: 'provision_coverage_ratio', label: 'Provision Coverage Ratio', unit: '%', hint: 'percentage' },
  { key: 'corporate_loan_pct', label: 'Corporate Loan %',      unit: '%',   hint: 'percentage'  },
  { key: 'sme_loan_pct',    label: 'SME Loan %',               unit: '%',   hint: 'percentage'  },
  { key: 'retail_loan_pct', label: 'Retail Loan %',            unit: '%',   hint: 'percentage'  },
